...
##' @format The format is: List of 2
##' \describe{
##' \item{\code{$Males}}{num [1:7] 193 188 185 183 180 175 170}
##' \item{\code{$Females}}{num [1:5] 178 173 168 165 163}
##' }
##' 
##' @references Zar, J.H. 2010. \emph{Biostatistical Analysis}. 5th
##'   Edition. Pearson Prentice-Hall. Upper Saddle River, NJ. ISBN-10:
...
##' Zar Data Set: ex12.04
##' 
##' @title Zar Data Set: ex12.04
##' 
##' @name ex12.04
##' 
##' @docType data
##' 
##' @format A data frame with 15 observations on the following 3 
##' variables.
##' \describe{
##' \item{\code{Block}}{a numeric vector coding for block}
##' \item{\code{Treatment}}{a numeric vector coding for treatment}
##' \item{\code{Time}}{a numeric vector for the time to anesthesia (min.)}
##' }
##' 
##' @references Zar, J.H. 2010. \emph{Biostatistical Analysis}. 5th
##'   Edition. Pearson Prentice-Hall. Upper Saddle River, NJ. ISBN-10:
...
##' \item{\code{Group.3}}{a numeric vector}
##' \item{\code{Group.4}}{a numeric vector}
##' }
##' 
##' @references Zar, J.H. 2010. \emph{Biostatistical Analysis}. 5th
##'   Edition. Pearson Prentice-Hall. Upper Saddle River, NJ. ISBN-10:
...
##' \item{\code{Source}}{a factor with levels \code{A}, \code{B}, \code{D},
...
##' \item{\code{month}}{a factor with levels \code{Dec},
